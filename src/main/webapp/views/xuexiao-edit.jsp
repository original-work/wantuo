...
<script type="text/javascript" src="<%=basePath %>js/xuexiao-edit.js"></script>
<body>
<div class="pd-20">
  <form id="form1" class="form form-horizontal">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        ...
        <input type="text" class="input-text" value=""  id="schoolName" name="schoolName" datatype="*2-16">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" id="fullName" name="fullName" datatype="*2-16">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <input type="hidden" name="locationName" id="locationName" >
        <select class="select" size="1" name="location"  id="location" datatype="*" onchange="changeData(this.value,null)">
        </select>
        </span> </div>
      <div class="col-4"> </div>
    </div>
    ...
    <input type="hidden" name="bairroName" id="bairroName">
      ...
      <div class="formControls col-5"> <span class="select-box">
        <select class="select" size="1" name="bairro"id="bairro" datatype="*" >
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="schoolContacts" name="schoolContacts" datatype="*2-16" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      <label class="form-label col-3"></label>
			<div class="ormControls col-5">
				<button onclick="editSchool()" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 确定</button>
