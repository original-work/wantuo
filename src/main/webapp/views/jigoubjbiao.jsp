...
<body>
	<nav class="breadcrumb">
    	<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 机构班级报表 <a class="btn btn-success radius r mr-20" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        <div class="pd-20">
        <div class="text-c">
            <div class="textbox">
                <ul>
        ...
        <div class="mt-20">
            <div id="classReport">
                <table class="table table-border table-bordered table-bg table-hover" id="classTable">
                    <thead>
                        <tr class="text-c">
                            <th>机构全称</th>
                            <th>班级数量</th>
...
<script type="text/javascript" src="<%=basePath %>js/jigoubanji.js"></script>
</html>
